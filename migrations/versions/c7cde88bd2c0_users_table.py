...
Revision ID: c7cde88bd2c0
Revises: 
Create Date: 2020-04-26 20:49:27.287370
...
def upgrade():
    ...
    sa.Column('phone_subscriber', sa.Boolean(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('body', sa.String(length=1140), nullable=True),
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
